    ...
    async with websockets.connect(url, extra_headers=headers) as ws:
        ...
        session_update = {
            ...
            "session": {
                ...
                "voice": "nova",
                "model": "tts-1-hd",
                "instructions": "You are an English/Swahili tutor. Please do not provide answers to questions but rather guide the students. Respond to the prompt in the language provided.",
                "modalities": ["audio"],
                "temperature": 0.2,
            }
        }
